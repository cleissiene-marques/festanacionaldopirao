...
export const metadata: Metadata = {
  ...
  description:
    "Tire suas dúvidas sobre teste grátis, velocidade de internet, aparelhos compatíveis, preços, pagamento, fidelidade e suporte da Festa NP IPTV.",
  alternates: { canonical: "/faq/" },
  openGraph: {
    url: "/faq/",
    title: "Perguntas Frequentes sobre IPTV | Festa NP IPTV",
    description:
      "Tire suas dúvidas sobre teste grátis, velocidade de internet, aparelhos compatíveis, preços, pagamento, fidelidade e suporte da Festa NP IPTV.",
  },
  twitter: {
  ...
  return (
    <>
      ...
      <section className="section" aria-labelledby="faq-list-heading">
        <div className="container">
          <h2 className="section-heading" id="faq-list-heading" style={{ textAlign: "center" }}>Dúvidas rápidas sobre a Festa NP IPTV</h2>
